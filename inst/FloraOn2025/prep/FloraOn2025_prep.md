...
-   Filtered to include occurrences from 2020/01/21 (downloaded data for
    AFLIBER 1.0.0) to 2025/02/18 (download day for AFLIBER 2.0.0).
...
```
    ...
    ## Rows: 101837 Columns: 2
    ## ── Column specification ────────────────────────────────────────────────────────
    ## Delimiter: ","
    ## chr (2): Taxon, UTM10x10
    ## 
...
```
    ...
    ## mutate: new variable 'UTM1x1' (logical) with one unique value and 100% NA
    ##         new variable 'References' (character) with one unique value and 0% NA
    ## mutate: changed 14,320 values (14%) of 'Taxon' (0 new NAs)
    ## select: no changes
...
```
    ...
    ## There are 806 non-valid taxa Erasing them.

    ## mutate: no changes
    ## There are 487 non-valid cells. Erasing them.
...
```
    ...
    ## filter: removed 75,574 rows (74%), 26,263 rows remaining
