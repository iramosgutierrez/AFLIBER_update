...
Data origin reference: Flora del PN de los Alcornocales Flora del PN
Cabo de Gata <!-- Flora de -->

Proyecto Environmental and Biodiversity Climate Change Lab (EnBiC2-Lab)
de la Universidad de Málaga. Laboratorio Virtual de Servicios
Ambientales-Equipo de FLORA. <https://enbic2lab.uma.es/services/flora>

A. V. Pérez Latorre, José García Sánchez, Noelia Hidalgo Triana, Teresa
Navarro del Águila, Federico Casimiro-Soriguer Solanas & Andros Solakis
Tena.

Primary data compiler: Andrés Vicente Perez Latorre
...
```
    ...
    ## rename: renamed one variable (speciesInterpreted)
    ## select: dropped 2 variables (institutionCode, MGRS)
...
```
    ...
    ## mutate: new variable 'UTM10x10' (character) with 55 unique values and 0% NA
    ...
    ## mutate: new variable 'Taxon' (character) with 2,956 unique values and <1% NA
    ## mutate: new variable 'subsp' (character) with 511 unique values and 88% NA
    ## mutate: changed 4,605 values (12%) of 'Taxon' (0 new NAs)
    ## select: dropped 4 variables (speciesInterpreted, decimalLatitude, decimalLongitude, subsp)
...
```
    ...
    ## There are 1430 non-valid taxa Erasing them.
...
```
    ...
    ## filter: removed 28,430 rows (73%), 10,694 rows remaining
