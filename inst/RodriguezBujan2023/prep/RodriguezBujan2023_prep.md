...
Data origin reference: Several papers published at Nova Acta Cientifica
Compostelana.
<https://revistas.usc.gal/index.php/nacc/article/view/9057/13124>
<https://revistas.uma.es/index.php/abm/article/view/12150/14369>
<https://revistas.ucm.es/index.php/BOCM/article/view/72929/4564456557652>
...
```
    ...
    ## mutate: new variable 'Taxon' (character) with 86 unique values and 0% NA
    ## rename: renamed 2 variables (UTM1x1, UTM10x10)
    ## mutate: new variable 'References' (character) with 199 unique values and 0% NA
...
```
    ...
    ## There are 4 non-valid taxa Erasing them.
...
```
    ...
    ## filter: removed 364 rows (99%), 4 rows remaining
