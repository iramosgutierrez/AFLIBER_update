...
Data origin reference: GBIF data from Jaén Herbarium

Primary data compiler: Carlos Salazar
...
```
    ...
    ## Warning: Expecting logical in DG1204 / R1204C111: got 'isotype'

    ## Warning: Expecting logical in DG2882 / R2882C111: got 'syntype'

    ## Warning: Expecting logical in DG3319 / R3319C111: got 'isotype'

    ## Warning: Expecting logical in DG5386 / R5386C111: got 'syntype'

    ## Warning: Expecting logical in DG7807 / R7807C111: got 'syntype'

    ## Warning: Expecting logical in S8485 / R8485C19: got 'Verdadero, Verdadero'

    ## Warning: Expecting logical in S8968 / R8968C19: got 'Verdadero, Verdadero'

    ## Warning: Expecting logical in AF9515 / R9515C32: got 'non-reproductive'

    ## Warning: Expecting logical in S9788 / R9788C19: got 'Verdadero, Verdadero'

    ## filter: removed 1,282 rows (12%), 9,185 rows remaining
    ## select: dropped 161 variables (Id, occurrenceID, type, modified, language, …)
...
```
    ...
    ## mutate: new variable 'Taxon' (character) with 1,843 unique values and 0% NA
    ## mutate: changed 47 values (1%) of 'VerbatimCoordinates' (0 new NAs)
    ## mutate: new variable 'UTM10x10' (character) with 376 unique values and <1% NA
    ## mutate: new variable 'UTM1x1' (character) with 1,703 unique values and 1% NA
    ## mutate: new variable 'References' (character) with one unique value and 0% NA
    ## select: dropped 4 variables (Genus, SpecificEpithet, InfraSpecificEpithet, VerbatimCoordinates)
...
```
    ...
    ## There are 553 non-valid taxa Erasing them.

    ## mutate: no changes
    ## There are 6 non-valid cells. Erasing them.
...
```
    ...
    ## filter: removed 7,134 rows (78%), 2,051 rows remaining
