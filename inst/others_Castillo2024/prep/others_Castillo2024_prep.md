...
```
    ...
    ## mutate: new variable 'References' (character) with 856 unique values and 0% NA
    ## select: dropped 4 variables (Sp. nov., Observaciones, Referencia bibliográfica, URL/DOI)
