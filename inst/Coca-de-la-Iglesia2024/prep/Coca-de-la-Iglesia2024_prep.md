Coca-de-la-Iglesia2024
================
Ignacio Ramos-Gutiérrez
2025-01-11

Data origin reference: Ivy distribution data from:

High rate of species misidentification reduces the taxonomic certainty
of European biodiversity databases of ivies (Hedera L.)
<https://doi.org/10.1038/s41598-024-54735-0>

Primary data compiler: Marina Coca

Other data compilers: Angélica Gallego, Alejandro Alonso, Virginia
Valcárcel

## Notes

-Should be the only data to be included, as others are prone to
errors. - Nomenclature of Hedera helix and iberica must be changed in
Taxon list
...
```
    ...
    ## mutate: new variable 'Taxon' (character) with 3 unique values and 0% NA
    ## mutate: new variable 'UTM10x10' (character) with 356 unique values and 0% NA
    ...
    ## select: dropped 67 variables (Project, ID_Loc, OriginalID_Loc, OGen, OSp, …)
...
```
    ...
    ## There are 2 non-valid taxa Erasing them.
...
```
    ...
    ## filter: removed 216 rows (44%), 279 rows remaining
