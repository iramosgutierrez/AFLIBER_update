...
González Ortega, D., E. Álvarez Gómez, J. Peláez Blanco, R. Sánchez
Fernández, N. Gallego Rojas & J. García Guerra (2024). Atlas de las
orquídeas silvestres de la ZEC Humada-Peña Amaya (Burgos). Flora
Montiberica 88: 3-30.
...
```
    ...
    ## New names:
    ## rename: renamed one variable (UTM10x10)
    ## • `` -> `...3`
...
```
    ...
    ## There are 7 non-valid taxa Erasing them.
...
```
    ...
    ## filter: removed 4,221 rows (86%), 681 rows remaining
