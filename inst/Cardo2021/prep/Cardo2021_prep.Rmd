...
https://www.researchgate.net/publication/372109563_Flora_Singular_y_Amenazada_de_la_provincia_de_Cuenca
...
```{r}
citationkey <- "Cardo2021"
dt_raw <- readr::read_csv(here(paste0("GitHub/inst/",citationkey,"/raw/FAS_Cuenca_OscarGC.csv")))
...
dt_modif <- dt_raw |> 
  ...
  mutate(References =   gsub("García Cardo et al., 2020", "García Cardo et al., 2021", References)) |> 
