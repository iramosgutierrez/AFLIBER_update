...
```
    ...
    ## mutate: new variable 'References' (character) with 1,137 unique values and 0% NA
    ## mutate: changed 26,119 values (>99%) of 'Taxon' (0 new NAs)
    ## mutate: changed 26,131 values (>99%) of 'Taxon' (0 new NAs)
    ...
    ## mutate: changed 3,173 values (12%) of 'Taxon' (0 new NAs)
    ## mutate: changed 52 values (<1%) of 'Taxon' (0 new NAs)
    ## select: dropped 6 variables (Sp. nov., Observaciones, Referencia bibliográfica, URL/DOI, ...8, …)
...
```
    ...
    ## There are 2215 non-valid taxa Erasing them.

    ## mutate: no changes
    ## There are 444 non-valid cells. Erasing them.
...
```
    ...
    ## filter: removed 13,695 rows (52%), 12,485 rows remaining
